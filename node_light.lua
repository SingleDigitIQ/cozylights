...
function cozylights:draw_node_light(pos, cozy_item, vm, a, data, param2data, fix_edges)
	local hash = (pos.z + 32768) * 4294967296 + (pos.y + 32768) * 65536 + (pos.x + 32768)
...
function cozylights:destroy_light(pos, cozy_item)
	...
	local posrebuilds = cozylights.find_nodes_in_area(rebuild_minp, rebuild_maxp, cozylights.source_nodes)
